    ...
    <footer className="py-12 border-t border-border/50 glass">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          >
            <h3 className="text-2xl font-bold neon-text mb-2">Kanika Designer/Developer</h3>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground mt-2">© 2024 Kanika Designer/Developer. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  )
